...
Config.VehiclePrice = 3 --Price of the vehicle to distribute the drugs.
Config.CustomersFindPrice = 1 --Price for requesting data from buyers..
...
Config.CopsRefreshTime = 300000 --Min 30000ms. If you put less it lowers the performance, if you put more, it is better

Config.SellGiveitem = false -- Give item or account money
Config.SellItemName = 'markedbills' -- If SellGiveitem = true 
Config.MoneyAccount = 'money' --Change account type, example: money, black_money or bank
...
Config.NormalSellChance = 5 -- 20% Normal Sale.
Config.DruggedSellChance = 5 -- 20% NPC is drugged and paid 2x.
Config.AttackSellChance = 5 -- 20% NPC robbing us.
Config.PoliceSellChance = 5 -- 20% NPC notifies the LSPD.
...
Config.Drugs = {
    Weed = {
        ...
        ItemWholesalePrice = 1, --Wholesaler's price.
